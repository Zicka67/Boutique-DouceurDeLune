...
INSERT INTO `products` (`id`, `categories_id`, `name`, `description`, `price`, `stock`, `created_at`, `slug`) VALUES
	(11, 107, 'Echarpe 1', 'Optio dolores molestias et id necessitatibus. Aut illo in minus voluptatem ut unde ad. Non sequi ut in voluptatem esse provident.', 10999, 7, '2023-09-17 15:12:04', 'quas'),
	(12, 107, 'Echarpe 2', 'Mollitia aut et vero nisi. Molestiae excepturi ab dolor aliquam eos qui ipsam. Nihil fuga id cumque et iure rerum.', 33889, 1, '2023-09-17 15:12:04', 'hic-officia'),
	(13, 106, 'Nam ut.', 'Vitae corporis hic omnis enim voluptatem soluta nemo. Consequatur aperiam repellendus vel soluta.', 38036, 3, '2023-09-17 15:12:04', 'nam-ut'),
	(14, 110, 'Officiis unde.', 'Aut laborum vel et quibusdam. Aut explicabo eveniet occaecati quam nemo veniam. Dolor quibusdam a harum similique expedita fugit error.', 86369, 10, '2023-09-17 15:12:04', 'officiis-unde'),
	(15, 110, 'Aut recusandae.', 'Dolor molestiae eos porro nulla dolorum placeat quia quam. Ab illo fugiat architecto aut.', 107691, 8, '2023-09-17 15:12:04', 'aut-recusandae'),
	...
	(20, 117, 'Nobis.', 'Dolor delectus a illum tempora. Ut debitis atque nemo aut recusandae omnis sed. Repudiandae repellat maxime excepturi est ex.', 133242, 2, '2023-09-17 15:12:04', 'nobis'),
	(21, 117, 'sint sed 2.', 'Et quae voluptates expedita accusamus. Eligendi qui vel dolores eius. Omnis est facilis in rerum quod.', 65158, 5, '2023-09-18 16:44:51', 'sint-sed-2');
...
INSERT INTO `users` (`id`, `email`, `roles`, `password`, `lastname`, `firstname`, `address`, `zipcode`, `city`, `created_at`) VALUES
	...
	(33, 'Admin@admin.com', '["ROLE_ADMIN"]', '$2y$13$KiMVwfYfxGzBzNwSPvRiOe9rWb1NhkO0ztMdhsS/qEivN9mlvChja', 'Admin', 'Admin', '2 rue de la ville', '67540', 'Ostwald', '2023-09-29 19:45:02');
