...
INSERT INTO `products` (`id`, `categories_id`, `name`, `description`, `price`, `stock`, `created_at`, `slug`) VALUES
	(11, 106, 'Echarpe physiologique', 'Offrez vous, ou offrez a une jeune ou future maman, notre echarpe physiologique faite main, respectant la peau de votre bébé et celle de la maman ( ou du papa ! )', 10999, 7, '2023-09-17 15:12:04', 'quas'),
	(12, 106, 'Porte bébé', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 33889, 1, '2023-09-17 15:12:04', 'hic-officia'),
	(13, 106, 'Porte bébé 2', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 38036, 3, '2023-09-17 15:12:04', 'nam-ut'),
	(14, 110, 'Tétine', 'Aut laborum vel et quibusdam. Aut explicabo eveniet occaecati quam nemo veniam. Dolor quibusdam a harum similique expedita fugit error.', 86369, 10, '2023-09-17 15:12:04', 'officiis-unde'),
	(15, 110, 'tire-laits', 'Dolor molestiae eos porro nulla dolorum placeat quia quam. Ab illo fugiat architecto aut.', 107691, 8, '2023-09-17 15:12:04', 'aut-recusandae'),
	(16, 110, 'Biberons', 'Cupiditate dolore nulla numquam eum est dolor ut. Maiores aut vero vitae porro et nemo eum eius.', 93284, 1, '2023-09-17 15:12:04', 'commodi'),
