...
INSERT INTO `products` (`id`, `categories_id`, `name`, `description`, `price`, `stock`, `created_at`, `slug`, `img_name`) VALUES
	(11, 106, 'Echarpe physiologique', 'Offrez vous, ou offrez a une jeune ou future maman, notre echarpe physiologique faite main, respectant la peau de votre bébé et celle de la maman', 9999, 8, '2023-09-17 15:12:04', 'quas', 'echarpesAnneauProduit.jpg'),
	(12, 106, 'Porte bébé', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 19999, 12, '2023-09-17 15:12:04', 'hic-officia', 'Porte-Bébé-Dust.jpg'),
	(13, 106, 'Porte bébé 2', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 24999, 5, '2023-09-17 15:12:04', 'nam-ut', 'porte-bebe-savane.jpg'),
	...
	(15, 110, 'Tire-laits', 'Dolor molestiae eos porro nulla dolorum placeat quia quam. Ab illo fugiat architecto aut.', 7999, 15, '2023-09-17 15:12:04', 'aut-recusandae', 'accessoires.webp'),
	(16, 110, 'Biberons', 'Cupiditate dolore nulla numquam eum est dolor ut. Maiores aut vero vitae porro et nemo eum eius.', 4999, 16, '2023-09-17 15:12:04', 'commodi', 'biberon.jpg'),
