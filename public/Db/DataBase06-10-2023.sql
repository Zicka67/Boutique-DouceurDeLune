...
-- Listage de la structure de la base pour e-commerce2
CREATE DATABASE IF NOT EXISTS `e-commerce2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `e-commerce2`;

-- Listage de la structure de table e-commerce2. categories
...
-- Listage des données de la table e-commerce2.categories : ~14 rows (environ)
...
-- Listage de la structure de table e-commerce2. coupons
...
-- Listage des données de la table e-commerce2.coupons : ~0 rows (environ)

-- Listage de la structure de table e-commerce2. coupons_types
...
-- Listage des données de la table e-commerce2.coupons_types : ~0 rows (environ)

-- Listage de la structure de table e-commerce2. doctrine_migration_versions
...
-- Listage des données de la table e-commerce2.doctrine_migration_versions : ~4 rows (environ)
...
-- Listage de la structure de table e-commerce2. images
...
-- Listage des données de la table e-commerce2.images : ~100 rows (environ)
...
-- Listage de la structure de table e-commerce2. messenger_messages
...
-- Listage des données de la table e-commerce2.messenger_messages : ~0 rows (environ)

-- Listage de la structure de table e-commerce2. orders
...
-- Listage des données de la table e-commerce2.orders : ~0 rows (environ)

-- Listage de la structure de table e-commerce2. orders_details
...
-- Listage des données de la table e-commerce2.orders_details : ~0 rows (environ)

-- Listage de la structure de table e-commerce2. products
...
-- Listage des données de la table e-commerce2.products : ~11 rows (environ)
INSERT INTO `products` (`id`, `categories_id`, `name`, `description`, `price`, `stock`, `created_at`, `slug`) VALUES
	(11, 106, 'Echarpe physiologique', 'Offrez vous, ou offrez a une jeune ou future maman, notre echarpe physiologique faite main, respectant la peau de votre bébé et celle de la maman ( ou du papa ! )', 9999, 10, '2023-09-17 15:12:04', 'quas'),
	(12, 106, 'Porte bébé', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 19999, 5, '2023-09-17 15:12:04', 'hic-officia'),
	(13, 106, 'Porte bébé 2', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 24999, 8, '2023-09-17 15:12:04', 'nam-ut'),
	(14, 110, 'Tétine', 'Aut laborum vel et quibusdam. Aut explicabo eveniet occaecati quam nemo veniam. Dolor quibusdam a harum similique expedita fugit error.', 1999, 7, '2023-09-17 15:12:04', 'officiis-unde'),
	(15, 110, 'tire-laits', 'Dolor molestiae eos porro nulla dolorum placeat quia quam. Ab illo fugiat architecto aut.', 7999, 6, '2023-09-17 15:12:04', 'aut-recusandae'),
	(16, 110, 'Biberons', 'Cupiditate dolore nulla numquam eum est dolor ut. Maiores aut vero vitae porro et nemo eum eius.', 4999, 0, '2023-09-17 15:12:04', 'commodi'),
	(17, 114, 'Sint sed.', 'Mollitia in et hic quia optio aut aliquam. Eos magni rem et commodi sit sed sed.', 51269, 8, '2023-09-17 15:12:04', 'sint-sed'),
	(18, 114, 'Quis ratione.', 'Et quae voluptates expedita accusamus. Eligendi qui vel dolores eius. Omnis est facilis in rerum quod.', 63376, 10, '2023-09-17 15:12:04', 'quis-ratione'),
	(19, 114, 'Perspiciatis.', 'Rem dolores earum nihil ut autem et. Aliquam non aut provident. Quia nihil sunt assumenda ipsa molestiae facilis. Omnis est ab ut id aliquam ut. Reprehenderit voluptas possimus est.', 51042, 9, '2023-09-17 15:12:04', 'perspiciatis'),
	(20, 117, 'Carte cadeau 50 €', 'Vous souhaitez offrir une consultation d\'allaitement, un atelier portage en écharpe pour bébé ou une séance de bien être Rebozo à l\'un de \r\nvos proches. <br> <br> Il vous suffit de cliquer pour offrir 50 € à la maman de votre choix ! ', 5000, 96, '2023-09-17 15:12:04', 'nobis'),
	(21, 117, 'Carte cadeau 100 €', 'Vous souhaitez offrir une consultation d\'allaitement, un atelier portage en écharpe pour bébé ou une séance de bien être Rebozo à l\'un de \r\nvos proches. <br> <br> Il vous suffit de cliquer pour offrir 100 € à la maman de votre choix ! ', 10000, 94, '2023-09-18 16:44:51', 'sint-sed-2');

-- Listage de la structure de table e-commerce2. users
...
-- Listage des données de la table e-commerce2.users : ~6 rows (environ)
