...
-- Listage des données de la table e-commerce.coupons_types : ~3 rows (environ)
...
-- Listage des données de la table e-commerce.doctrine_migration_versions : ~4 rows (environ)
INSERT INTO `doctrine_migration_versions` (`version`, `executed_at`, `execution_time`) VALUES
	...
	('DoctrineMigrations\\Version20231006064538', '2023-10-13 11:40:09', 95);
...
-- Listage des données de la table e-commerce.products : ~11 rows (environ)
INSERT INTO `products` (`id`, `categories_id`, `name`, `description`, `price`, `stock`, `created_at`, `slug`, `img_name`) VALUES
	(11, 106, 'Echarpe physiologique', 'Offrez vous, ou offrez a une jeune ou future maman, notre echarpe physiologique faite main, respectant la peau de votre bébé et celle de la maman ( ou du papa ! )', 9999, 19, '2023-09-17 15:12:04', 'quas', 'echarpesAnneauProduit.jpg'),
	(12, 106, 'Porte bébé', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 19999, 15, '2023-09-17 15:12:04', 'hic-officia', 'Porte-Bébé-Dust.jpg'),
	(13, 106, 'Porte bébé 2', 'Notre game de portage comporte également des portes bébé, fait main également, souple mais robuste. Pour un confort parfait pour bébé et pour vous.', 24999, 10, '2023-09-17 15:12:04', 'nam-ut', 'porte-bebe-savane.jpg'),
	(14, 110, 'Tétine', 'Aut laborum vel et quibusdam. Aut explicabo eveniet occaecati quam nemo veniam. Dolor quibusdam a harum similique expedita fugit error.', 1999, 12, '2023-09-17 15:12:04', 'officiis-unde', 'tetine2.png'),
	(15, 110, 'tire-laits', 'Dolor molestiae eos porro nulla dolorum placeat quia quam. Ab illo fugiat architecto aut.', 7999, 11, '2023-09-17 15:12:04', 'aut-recusandae', 'tire-lait.webp'),
	(16, 110, 'Biberons', 'Cupiditate dolore nulla numquam eum est dolor ut. Maiores aut vero vitae porro et nemo eum eius.', 4999, 11, '2023-09-17 15:12:04', 'commodi', 'biberon.jpg'),
	(17, 114, 'Sint sed.', 'Mollitia in et hic quia optio aut aliquam. Eos magni rem et commodi sit sed sed.', 51269, 8, '2023-09-17 15:12:04', 'sint-sed', NULL),
	(18, 114, 'Quis ratione.', 'Et quae voluptates expedita accusamus. Eligendi qui vel dolores eius. Omnis est facilis in rerum quod.', 63376, 10, '2023-09-17 15:12:04', 'quis-ratione', NULL),
	(19, 114, 'Perspiciatis.', 'Rem dolores earum nihil ut autem et. Aliquam non aut provident. Quia nihil sunt assumenda ipsa molestiae facilis. Omnis est ab ut id aliquam ut. Reprehenderit voluptas possimus est.', 51042, 9, '2023-09-17 15:12:04', 'perspiciatis', NULL),
	(20, 117, 'Carte cadeau 50 €', 'Vous souhaitez offrir une consultation d\'allaitement, un atelier portage en écharpe pour bébé ou une séance de bien être Rebozo à l\'un de \r\nvos proches. <br> <br> Il vous suffit de cliquer pour offrir 50 € à la maman de votre choix ! ', 5000, 96, '2023-09-17 15:12:04', 'nobis', NULL),
	(21, 117, 'Carte cadeau 100 €', 'Vous souhaitez offrir une consultation d\'allaitement, un atelier portage en écharpe pour bébé ou une séance de bien être Rebozo à l\'un de \r\nvos proches. <br> <br> Il vous suffit de cliquer pour offrir 100 € à la maman de votre choix ! ', 10000, 94, '2023-09-18 16:44:51', 'sint-sed-2', NULL);
